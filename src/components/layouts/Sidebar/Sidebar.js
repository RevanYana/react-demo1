      ...
      <div className="app-sidebar-menu overflow-hidden flex-column-fluid">
        ...
        >
          ...
          <div className="menu menu-column menu-rounded menu-sub-indention px-3" id="#kt_app_sidebar_menu" data-kt-menu="true" data-kt-menu-expand="false">
              ...
              <div className="menu-sub menu-sub-accordion">
                ...
                <div data-kt-menu-trigger="click" className="menu-item menu-accordion">
                  ...
                  <div className="menu-sub menu-sub-accordion menu-active-bg">
                    ...
                    <div className="menu-item">
                      {/*begin:Menu link*/}
                      <a className="menu-link" href="../../demo1/dist/authentication/layouts/overlay/two-steps.html">
                        <span className="menu-bullet">
                          <span className="bullet bullet-dot" />
                        </span>
                        <span className="menu-title">Two-steps</span>
                ...
                <div data-kt-menu-trigger="click" className="menu-item menu-accordion">
                  ...
                  <div className="menu-sub menu-sub-accordion menu-active-bg">
                    ...
                    <div className="menu-item">
                      {/*begin:Menu link*/}
                      <a className="menu-link" href="../../demo1/dist/authentication/layouts/creative/two-steps.html">
                        <span className="menu-bullet">
                          <span className="bullet bullet-dot" />
                        </span>
                        <span className="menu-title">Two-steps</span>
                ...
                <div data-kt-menu-trigger="click" className="menu-item menu-accordion">
                  ...
                  <div className="menu-sub menu-sub-accordion menu-active-bg">
                    ...
                    <div className="menu-item">
                      {/*begin:Menu link*/}
                      <a className="menu-link" href="../../demo1/dist/authentication/layouts/fancy/two-steps.html">
                        <span className="menu-bullet">
                          <span className="bullet bullet-dot" />
                        </span>
                        <span className="menu-title">Two-steps</span>
                ...
                <div data-kt-menu-trigger="click" className="menu-item menu-accordion">
                  ...
                  <div className="menu-sub menu-sub-accordion menu-active-bg">
                    ...
                    <div className="menu-item">
                      {/*begin:Menu link*/}
                      <a className="menu-link" href="../../demo1/dist/authentication/email/reset-password.html" target="blank">
                        <span className="menu-bullet">
                          <span className="bullet bullet-dot" />
                        </span>
                        <span className="menu-title">Reset Password</span>
            ...
            <div className="menu-item">
              {/*begin:Menu link*/}
              <a className="menu-link" href="../../demo1/dist/documentation/base/utilities.html">
                <span className="menu-icon">
            ...
            <div className="menu-item">
              {/*begin:Menu link*/}
              <a className="menu-link" href="../../demo1/dist/documentation/getting-started.html">
                <span className="menu-icon">
