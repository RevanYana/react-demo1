        ...
        <div className="d-flex align-items-stretch justify-content-between flex-lg-grow-1" id="kt_app_header_wrapper">
          ...
          >
            ...
            <div className="menu menu-rounded menu-column menu-lg-row my-5 my-lg-0 align-items-stretch fw-semibold px-2 px-lg-0" id="kt_app_header_menu" data-kt-menu="true">
              {/*begin:Menu item*/}
              <div data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="bottom-start" className="menu-item here show menu-lg-down-accordion menu-here-bg me-0 me-lg-2">
                {/*begin:Menu link*/}
                    ...
                    <div className="row">
                      ...
                      <div className="col-lg-8 mb-3 mb-lg-0 py-3 px-3 py-lg-6 px-lg-6">
                        ...
                        <div className="d-flex flex-stack flex-wrap flex-lg-nowrap gap-2 mx-5">
                          ...
                          <a href="../../demo1/dist/landing.html" className="btn btn-sm btn-primary fw-bold">
                            Explore
                          </a>
                        </div>
                        {/*end:Landing*/}
                    ...
                    <div className="d-flex w-100 overflow-auto">
                      <ul className="nav nav-stretch nav-line-tabs fw-bold fs-6 p-0 p-lg-10 flex-nowrap flex-grow-1">
                        ...
                        <li className="nav-item mx-lg-1">
                          <a className="nav-link py-3 py-lg-6 active text-active-primary" href="#" data-bs-toggle="tab" data-bs-target="#kt_app_header_menu_pages_pages">
                            General
                          </a>
                        </li>
                        {/*end:Nav item*/}
                        {/*begin:Nav item*/}
                        <li className="nav-item mx-lg-1">
                          <a className="nav-link py-3 py-lg-6 text-active-primary" href="#" data-bs-toggle="tab" data-bs-target="#kt_app_header_menu_pages_account">
                            Account
                          </a>
                        </li>
                        {/*end:Nav item*/}
                        {/*begin:Nav item*/}
                        <li className="nav-item mx-lg-1">
                          <a className="nav-link py-3 py-lg-6 text-active-primary" href="#" data-bs-toggle="tab" data-bs-target="#kt_app_header_menu_pages_authentication">
                            Authentication
                          </a>
                        </li>
                        {/*end:Nav item*/}
                        {/*begin:Nav item*/}
                        <li className="nav-item mx-lg-1">
                          <a className="nav-link py-3 py-lg-6 text-active-primary" href="#" data-bs-toggle="tab" data-bs-target="#kt_app_header_menu_pages_utilities">
                            Utilities
                          </a>
                        </li>
                        {/*end:Nav item*/}
                        {/*begin:Nav item*/}
                        <li className="nav-item mx-lg-1">
                          <a className="nav-link py-3 py-lg-6 text-active-primary" href="#" data-bs-toggle="tab" data-bs-target="#kt_app_header_menu_pages_widgets">
                            Widgets
                          </a>
                        </li>
                        {/*end:Nav item*/}
                        ...
                        <div className="row">
                          ...
                          <div className="col-lg-3 mb-6 mb-lg-0">
                            ...
                            <div className="mb-0">
                              ...
                              <div className="menu-item p-0 m-0">
                                {/*begin:Menu link*/}
                                <a href="../../demo1/dist/authentication/layouts/overlay/two-steps.html" className="menu-link">
                                  <span className="menu-title">Two-steps</span>
                                </a>
                                {/*end:Menu link*/}
                              </div>
                          ...
                          <div className="col-lg-3 mb-6 mb-lg-0">
                            ...
                            <div className="mb-6">
                              ...
                              <div className="menu-item p-0 m-0">
                                {/*begin:Menu link*/}
                                <a href="../../demo1/dist/authentication/layouts/creative/two-steps.html" className="menu-link">
                                  <span className="menu-title">Two-steps</span>
                                </a>
                                {/*end:Menu link*/}
                              </div>
                            ...
                            <div className="mb-6">
                              ...
                              <div className="menu-item p-0 m-0">
                                {/*begin:Menu link*/}
                                <a href="../../demo1/dist/authentication/layouts/fancy/two-steps.html" className="menu-link">
                                  <span className="menu-title">Two-steps</span>
                                </a>
                                {/*end:Menu link*/}
                              </div>
                          ...
                          <div className="col-lg-3 mb-6 mb-lg-0">
                            ...
                            <div className="mb-0">
                              ...
                              <div className="menu-item p-0 m-0">
                                {/*begin:Menu link*/}
                                <a href="../../demo1/dist/authentication/extended/coming-soon.html" className="menu-link">
                          ...
                          <div className="col-lg-3 mb-6 mb-lg-0">
                            ...
                            <div className="mb-0">
                              ...
                              <div className="menu-item p-0 m-0">
                                {/*begin:Menu link*/}
                                <a href="../../demo1/dist/authentication/email/verify-email.html" className="menu-link">
                                  <span className="menu-title">Verify Email</span>
                                </a>
                                {/*end:Menu link*/}
                              </div>
                              ...
                              <div className="menu-item p-0 m-0">
                                {/*begin:Menu link*/}
                                <a href="../../demo1/dist/authentication/email/invitation.html" className="menu-link">
                              ...
                              <div className="menu-item p-0 m-0">
                                {/*begin:Menu link*/}
                                <a href="../../demo1/dist/authentication/email/password-change.html" className="menu-link">
                    ...
                    <div className="row">
                      ...
                      <div className="col-lg-6">
                        ...
                        <div className="d-flex flex-stack flex-wrap flex-lg-nowrap gap-2 mb-5 mb-lg-0 mx-lg-5">
                          ...
                          <a href="https://preview.keenthemes.com/metronic8/demo1/layout-builder.html" className="btn btn-sm btn-primary fw-bold">
                            Try Builder
                          </a>
                        </div>
                        {/*end:Layout Builder*/}
                      ...
                      <div className="col-lg-6 mb-3 py-lg-3 pe-lg-8 d-flex align-items-center">
                        <img src="assets/media/stock/900x600/45.jpg" className="rounded mw-100" alt="" />
                      </div>
                      {/*end:Col*/}
                    </div>
                    {/*end:Row*/}
                ...
                <div className="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown px-lg-2 py-lg-4 w-lg-200px">
                  ...
                  <div className="menu-item">
                    ...
                    <a className="menu-link" href="../../demo1/dist/documentation/getting-started/changelog.html">
                      ...
                      <span className="menu-title">Changelog v8.1.0</span>
                    </a>
                    {/*end:Menu link*/}
                  </div>
                  {/*end:Menu item*/}
          ...
          <div className="app-navbar flex-shrink-0">
                ...
                <div data-kt-search-element="content" className="menu menu-sub menu-sub-dropdown p-7 w-325px w-md-375px">
                  ...
                  <form data-kt-search-element="advanced-options-form" className="pt-1 d-none">
                    ...
                    <div className="d-flex justify-content-end">
                      ...
                      <a href="../../demo1/dist/pages/search/horizontal.html" className="btn btn-sm fw-bold btn-primary" data-kt-search-element="advanced-options-form-search">
                        Search
                      </a>
                    </div>
                    {/*end::Actions*/}
                ...
                <div className="tab-content">
                  ...
                  <div className="tab-pane fade" id="kt_topbar_notifications_1" role="tabpanel">
                    ...
                    <div className="py-3 text-center border-top">
                      <a href="../../demo1/dist/pages/user-profile/activity.html" className="btn btn-color-gray-600 btn-active-color-primary">
                        View All
            ...
            <div className="app-navbar-item ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
              ...
              <div className="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-primary fw-semibold py-4 fs-6 w-275px" data-kt-menu="true">
                {/*begin::Menu item*/}
                ...
                <div className="menu-item px-5" data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="left-start">
                  ...
                  <div className="menu-sub menu-sub-dropdown w-175px py-4">
                    {/*begin::Menu item*/}
                    <div className="menu-item px-3">
                      <a href="../../demo1/dist/account/referrals.html" className="menu-link px-5">
                        Referrals
                      </a>
                    </div>
                    {/*end::Menu item*/}
                    ...
                    {/*begin::Menu item*/}
                    <div className="menu-item px-3">
                      <a href="../../demo1/dist/account/statements.html" className="menu-link d-flex flex-stack px-5">
                        Statements
                        <i className="fas fa-exclamation-circle ms-2 fs-7" data-bs-toggle="tooltip" title="View your statements" />
                      </a>
                    </div>
                    {/*end::Menu item*/}
                    {/*begin::Menu separator*/}
                ...
                {/*begin::Menu item*/}
                <div className="menu-item px-5">
                  <a href="../../demo1/dist/authentication/flows/basic/sign-in.html" className="menu-link px-5">
                    Sign Out
                  </a>
                </div>
                {/*end::Menu item*/}
