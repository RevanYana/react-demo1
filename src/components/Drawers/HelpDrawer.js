          ...
          <div id="kt_help_scroll" className="hover-scroll-overlay-y" data-kt-scroll="true" data-kt-scroll-height="auto" data-kt-scroll-wrappers="#kt_help_body" data-kt-scroll-dependencies="#kt_help_header" data-kt-scroll-offset="5px">
            ...
            <div className="d-flex align-items-center mb-7">
              ...
              <div className="d-flex flex-stack flex-grow-1 ms-4 ms-lg-6">
                ...
                <div className="d-flex flex-column me-2 me-lg-5">
                  {/*begin::Title*/}
                  <a href="../../demo1/dist/documentation/getting-started.html" className="text-dark text-hover-primary fw-bold fs-6 fs-lg-4 mb-1">
            ...
            <div className="d-flex align-items-center mb-7">
              ...
              <div className="d-flex flex-stack flex-grow-1 ms-4 ms-lg-6">
                ...
                <div className="d-flex flex-column me-2 me-lg-5">
                  {/*begin::Title*/}
                  <a href="../../demo1/dist/documentation/base/utilities.html" className="text-dark text-hover-primary fw-bold fs-6 fs-lg-4 mb-1">
                    Plugins &amp; Components
                  </a>
                  {/*end::Title*/}
                  {/*begin::Description*/}
            ...
            <div className="d-flex align-items-center mb-7">
              ...
              <div className="d-flex flex-stack flex-grow-1 ms-4 ms-lg-6">
                ...
                <div className="d-flex flex-column me-2 me-lg-5">
                  {/*begin::Title*/}
                  <a href="https://preview.keenthemes.com/metronic8/demo1/layout-builder.html" className="text-dark text-hover-primary fw-bold fs-6 fs-lg-4 mb-1">
                    Layout Builder
                  </a>
                  {/*end::Title*/}
                  {/*begin::Description*/}
            ...
            <div className="d-flex align-items-center mb-7">
              ...
              <div className="d-flex flex-stack flex-grow-1 ms-4 ms-lg-6">
                ...
                <div className="d-flex flex-column me-2 me-lg-5">
                  {/*begin::Title*/}
                  <a href="https://devs.keenthemes.com/metronic" className="text-dark text-hover-primary fw-bold fs-6 fs-lg-4 mb-1">
                    Metronic Downloads
                  </a>
                  {/*end::Title*/}
                  {/*begin::Description*/}
            ...
            <div className="d-flex align-items-center mb-7">
              ...
              <div className="d-flex flex-stack flex-grow-1 ms-4 ms-lg-6">
                ...
                <div className="d-flex flex-column me-2 me-lg-5">
                  {/*begin::Title*/}
                  <a href="../../demo1/dist/documentation/getting-started/changelog.html" className="text-dark text-hover-primary fw-bold fs-6 fs-lg-4 mb-1">
                    What's New
                  </a>
                  {/*end::Title*/}
                  {/*begin::Description*/}
